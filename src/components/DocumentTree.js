...
class DocumentTree extends BaseDesignComponent {
    ...
    onRightClick(info) {
        ...
        if (info.node.props.isLeaf) {
            ...
            document.designData.currentContextMenu = ReactDOM.render(<ul><li><button onClick={tree.editDocument}>{config.textmsg.loaddocument}</button></li><li><button onClick={tree.deleteDocument}>{config.textmsg.deletedocument}</button></li></ul>, cm);
        } 
    }
